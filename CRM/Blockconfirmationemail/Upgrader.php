 ...
 */
class CRM_Blockconfirmationemail_Upgrader extends CRM_Blockconfirmationemail_Upgrader_Base {
   ...
   */
   public function postInstall() {
      // For all existing mailing_component entities of the relevant types,
      // append our special marker to the subject, so that those emails can
